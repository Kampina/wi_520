...
public class ConditionPlayerRace extends Condition
{
	...
	public boolean testImpl(Creature effector, Creature effected, Skill skill, ItemTemplate item)
	{
		...
		if ((item instanceof Armor armor) && (effector.asPlayer().getRace() == Race.KAMAEL))
		{
			final ArmorType armorType = armor.getItemType();
			if ((armorType == ArmorType.HEAVY) || (armorType == ArmorType.MAGIC) || (armorType == ArmorType.SHIELD) || (armorType == ArmorType.SIGIL))
			{
				return true;
			}
		}
