...
public class StatSet
{
	...
	public <T extends Enum<T>> T getEnum(String key, Class<T> enumClass)
	{
		...
		final String enumValue = String.valueOf(val);
		try
		{
		...
		{
			final T normalizedValue = getLegacyEnumValue(enumClass, enumValue);
			if (normalizedValue != null)
			{
				return normalizedValue;
			}
			if (enumValue.startsWith("TARGET_"))
			{
				try
				{
					return Enum.valueOf(enumClass, enumValue.substring("TARGET_".length()));
				}
	...
	private <T extends Enum<T>> T getLegacyEnumValue(Class<T> enumClass, String enumValue)
	{
		if (("BUFF".equals(enumValue)) && "BasicProperty".equals(enumClass.getSimpleName()))
		{
			return Enum.valueOf(enumClass, "NONE");
		}
		return null;
	}
