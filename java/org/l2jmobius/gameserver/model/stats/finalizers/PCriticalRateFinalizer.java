...
public class PCriticalRateFinalizer implements IStatFunction
{
	...
	public double calc(Creature creature, OptionalDouble base, Stat stat)
	{
		...
		// Dark attribute bonus (critical rate)
		final double darkBonus = creature.isPlayer() ? creature.getStat().getEquippedAttributeTotal(AttributeType.DARK) * 10.0 : 0;
		
		return validateValue(creature, Stat.defaultValue(creature, stat, baseValue * dexBonus * 10) + darkBonus, 0, maxPhysicalCritRate);
	}
